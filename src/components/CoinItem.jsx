...
const CoinItem = ({ coin }) => {
  return (
    <div className="text-white flex justify-between items-center shadow-lg rounded-lg lg:mx-4 my-8  px-6 py-3 hover:scale-105 transition-all duration-300 cursor-pointer w-full bg-gray-800   ">
